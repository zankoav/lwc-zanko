...
var regs = {
    ...
    vatIdFormat_DE: /^([Dd]{1}[Ee]{1}[0-9]{9})+$/,
...
$j(document).ready(function () {
    ...
    if (vatIdInput.val() != '' && vatIdInput.val() != undefined) {
        isInputValueValid(vatIdInput, new RegExp(regs.vatIdFormat_DE));
    }
...
function setEvents_vatNumber() {
    ...
    vatNumberInput.on('input', function(e){
        isInputValueValid(vatNumberInput, new RegExp(regs.vatIdFormat_DE));
        isVatValid = isInputValueValid(vatNumberInput, new RegExp(regs.vatIdFormat_DE));
        if (isVatValid) {
